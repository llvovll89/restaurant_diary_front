        ...
        <aside
            className={`${
                locationPath !== MAIN
                    ...
                    : "h-[calc(100vh-100px)] top-[100px]"
            } fixed left-0 w-[350px]  bg-white z-[50] overflow-hidden border-r border-t border-solid border-[#DEDEDE]`}
        >
            ...
            <div className="w-full border-t border-solid border-[#DEDEDE] h-[56px] absolute bottom-0 left-0 flex items-center">
                ...
                <div
                    className={`${
                        isOnline ? "" : "bg-[#DEDEDE] bg-opacity-70"
                    } w-[52px] h-full border-r border-solid border-[#DEDEDE] flex items-center justify-center`}
                >
