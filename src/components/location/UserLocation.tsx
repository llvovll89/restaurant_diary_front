...
export const UserLocation = () => {
    ...
    return (
        <button title="현재 내 위치로" onClick={onClick} className="fixed bottom-[16px] right-[6px] w-[36px] h-[36px] rounded-[5px] bg-[rgba(0,0,0,0.77)] flex items-center justify-center z-[10]">
